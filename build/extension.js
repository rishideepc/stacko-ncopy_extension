...
let globalStorage = {}
console.log("StackOnCopy running!");
let stackCpy = vscode.commands.registerCommand('StackOnCopy.stackCpy',async function () {
let funcName = "stack_cpy"; let pyVar = "python";
